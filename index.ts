...
export type TMessagesREST = {
  ...
  NOT_DELETE: string
  ERROR_DELETE: string
  DELETE_SYSTEM_DOCUMENT: string
  NOT_DELETE_SYSTEM_DOCUMENT: string
  ERROR_DELETE_SYSTEM_DOCUMENT: string
  DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: string
  NOT_DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: string
  ERROR_DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: string
  DELETE_MANY: string
...
export const messagesREST = (prefix: string, suffix: string = ''): TMessagesREST => {
  return {
    ...
    DELETE_SYSTEM_DOCUMENT: `${prefix}_DELETE_SYSTEM_DOCUMENT${suffix}`,
    NOT_DELETE_SYSTEM_DOCUMENT: `${prefix}_NOT_DELETE_SYSTEM_DOCUMENT${suffix}`,
    ERROR_DELETE_SYSTEM_DOCUMENT: `${prefix}_ERROR_DELETE_SYSTEM_DOCUMENT${suffix}`,

    DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: `${prefix}_DELETE_SYSTEM_DOCUMENT${suffix}`,
    NOT_DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: `${prefix}_NOT_DELETE_SYSTEM_DOCUMENT${suffix}`,
    ERROR_DELETE_MANY_WITHOUT_SYSTEM_DOCUMENT: `${prefix}_ERROR_DELETE_SYSTEM_DOCUMENT${suffix}`,
